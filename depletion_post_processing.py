...
results = openmc.deplete.Results(filename='current_depletion_results.h5')
...
selected_nuclides = [
    ...
    "Sm151", "Tc99", "I129", "I131","Cs135", "Zr93",
    "Se79", "Ru106", "Pd107", "Si28", "Si29", "Si30",
    "Al27", "C12", "C13", "Fe54", "Fe56", "Fe57", "Fe58",
    "O16", "O17", "O18", "N14", "N15"]
...
for key, value in nuclides_i_dict.items():
...
u233_weight_0 = ((results.get_atoms(mat=fuel, nuc='U233', nuc_units='atoms')[1][0]) *  233.039634) / (constants.Avogadro)
u233_weight_1 = ((results.get_atoms(mat=fuel, nuc='U233', nuc_units='atoms')[1][-1]) * 233.039634) / (constants.Avogadro)
...
print(f'\nCurrent U233 loss by weight is {u233_weight_0 - u233_weight_1:.6} grams')